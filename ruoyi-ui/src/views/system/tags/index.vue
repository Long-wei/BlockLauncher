<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标签URL标识" prop="slug">
        <el-input
          v-model="queryParams.slug"
          placeholder="请输入标签URL标识"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="tagsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签URL标识" align="center" prop="slug" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="标签URL标识" prop="slug">
          <el-input v-model="form.slug" placeholder="请输入标签URL标识" />
        </el-form-item>
        <el-form-item label="标签描述" prop="description">
...
<script>
import { listTags, getTags, delTags, addTags, updateTags } from "@/api/system/tags"
